...
import {DataGrid, type GridColDef, GridColumnHeaderParams} from "@mui/x-data-grid";
...
type ModifierRequestType<K extends keyof ApiRequest> = Omit<ApiRequest, K> & {
    timestamp: string
}

interface TableProps {
    userRequests: ModifierRequestType<'timestamp'>[]
}
